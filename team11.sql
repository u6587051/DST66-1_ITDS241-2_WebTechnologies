...
("01","ใบตัด New Kosoku",349,99,"ขนาด4x4"),
("02","MAKITA สว่าน DF001G Cordless Driver Drill",3500,99,"40V"),
("03","เครื่องตัดเหล็ก 12 Stanley",1400,99,"#15-166"),
("04","ใบตัด Corolla",500,99,"ขนาด4x1"),
("05","MAKITA สว่านไร้สาย สว่าน 3 ระบบ",849,99,"148V"),
("06","Total ปั๊มลมอัตโนมัติ ปั๊มลมมินิ",1169,99,"12V 18A แรงดัน 120 PSI");
